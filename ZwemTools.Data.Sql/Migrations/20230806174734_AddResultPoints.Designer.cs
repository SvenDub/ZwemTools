...
namespace ZwemTools.Data.Sql.Migrations
{
    ...
    [Migration("20230806174734_AddResultPoints")]
    partial class AddResultPoints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZwemTools.Data.Sql.Entry", b =>
                {
                    ...
                    b.Property<int>("LenexEventId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("LenexHeatId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ZwemTools.Data.Sql.Heat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ZwemTools.Data.Sql.Entry", b =>
                {
                    ...
                    b.HasOne("ZwemTools.Data.Sql.Heat", "Heat")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("ZwemTools.Data.Sql.Heat", b =>
                {
                    b.HasOne("ZwemTools.Data.Sql.Event", null)
                        .WithMany("Heats")
                        .HasForeignKey("EventId");
                });
            ...
            modelBuilder.Entity("ZwemTools.Data.Sql.Meet", b =>
                {
                    ...
                    b.OwnsOne("ZwemTools.Data.Sql.Pool", "Pool", b1 =>
                        {
                            b1.Property<int>("MeetId")
                                .HasColumnType("INTEGER");

                            b1.Property<int?>("LaneMax")
                                .HasColumnType("INTEGER");

                            b1.Property<int?>("LaneMin")
                                .HasColumnType("INTEGER");
